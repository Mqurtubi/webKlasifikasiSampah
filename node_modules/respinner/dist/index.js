...
const BeatLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$8({}, rest, {
        width: viewWidth,
        height: size
...
const CircularLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$6({}, rest, {
...
const ClockLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$5({}, rest, {
        width: size,
        height: size,
    ...
    }), /*#__PURE__*/ React__default.default.createElement("line", _extends$5({}, needleProps, {
...
const RotateLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", {
        width: size,
        height: size
    }, /*#__PURE__*/ React__default.default.createElement("circle", _extends$4({}, circleProps, {
        style: {
            opacity
        }
    })), /*#__PURE__*/ React__default.default.createElement("circle", _extends$4({}, circleProps, {
...
const SpinLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$3({}, rest, {
        width: size,
        height: size
    }), repeat(count).map((_, i)=>{
...
const WaveLoading = (_param)=>{
    ...
    const radius = size / 2 - strokeWidth;
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$2({}, rest, {
        width: size,
        height: size
    }), repeat(count).map((_, i)=>{
        const pos = size / 2;
...
const InlineSvgStyle = ({ animation  })=>/*#__PURE__*/ React__default.default.createElement("style", null, svgStyle(animation));
...
const DashLoading = (_param)=>{
    ...
    return /*#__PURE__*/ React__default.default.createElement("svg", _extends$1({}, rest, {
        width: size,
        height: size
    }), /*#__PURE__*/ React__default.default.createElement(InlineSvgStyle, {
...
exports.BeatLoading = BeatLoading;
exports.BounceLoading = BounceLoading;
exports.CircularLoading = CircularLoading;
exports.ClockLoading = ClockLoading;
exports.CopperLoading = CopperLoading;
exports.DashLoading = DashLoading;
exports.RotateLoading = RotateLoading;
